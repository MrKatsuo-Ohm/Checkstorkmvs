...
import { AlertTriangle, CheckCircle, Package, Edit3 } from 'lucide-react'
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h2 className="text-xl md:text-2xl font-bold flex items-center gap-2">
          <AlertTriangle className="w-5 h-5 md:w-6 md:h-6 text-amber-400" />สินค้าที่ต้องสั่งเพิ่ม
        </h2>
                ...
                <div key={item.id} className="bg-slate-800 border border-slate-700 rounded-2xl p-4">
                  ...
                  <div className="grid grid-cols-3 gap-2 mb-3 text-center text-sm">
                    <div className="bg-slate-700/50 rounded-lg p-2">
                      ...
                      <p className={`font-bold ${status.className} mt-0.5`}>{item.quantity}</p>
                    </div>
                    <div className="bg-slate-700/50 rounded-lg p-2">
